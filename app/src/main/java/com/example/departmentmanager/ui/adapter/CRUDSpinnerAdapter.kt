...
import com.example.departmentmanager.databinding.LayoutItemCrudBinding
...
class CRUDSpinnerAdapter(private val dataSet: MutableList<ItemSpinner>) : BaseAdapter() {
    ...
    fun initView(position: Int, view: View?, parent: ViewGroup?): View{
        ...
        val binding =DataBindingUtil.inflate(layoutInflater,R.layout.layout_item_crud, parent, false) as LayoutItemCrudBinding
